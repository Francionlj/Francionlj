...
<img align="right" height="120" width="140" src="https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3YzFmd3FxeTByYmhrbHFydDVyNHlrM3ZjbHZhNWlpejVseTJiZDNoeiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/ITRemFlr5tS39AzQUL/giphy.gif" alt="Machine Learning Gif" style="margin-left: 20px; margin-bottom: 20px;" />

  👋 Welcome to my GitHub!<br>
  <small>
    My name is Francion Linhares Justino.<br>
    I am a Data Scientist passionate about uncovering insights and solving real-world problems through data.
  </small>
...
<details>
  ...
  If you want, I can help you refine this further or make it more formal or casual according to your preferences. \o/
</details>
...
<div align="left" style="margin: 20px 0;">
  ...
  <a href="https://www.tiktok.com/@YOUR_TIKTOK_USERNAME" target="_blank" title="TikTok">
  ...
  <a href="https://wa.me/YOUR_WHATSAPP_NUMBER" target="_blank" title="WhatsApp">
  ...
  <a href="https://www.kaggle.com/YOUR_KAGGLE_USERNAME" target="_blank" title="Kaggle Profile">
    <img src="https://img.shields.io/static/v1?message=Kaggle&logo=kaggle&color=20BEFF&logoColor=white&style=for-the-badge" height="35" alt="kaggle logo" />
  </a>
  -->
</div>
...
<div align="left" style="margin-bottom: 30px;">
  ...
  <a href="https://www.tensorflow.org/api_docs" target="_blank" title="TensorFlow Documentation">
  ...
  <a href="https://pytorch.org/docs/stable/index.html" target="_blank" title="PyTorch Documentation">
  ...
  <!-- Automation -->
  <a href="https://www.selenium.dev/documentation/en/" target="_blank" title="Selenium Documentation">
...
<!-- GIF -->
<p align="center">
  <img align="center" src="image/git .gif" alt="Imagem">
</p>

<hr>

<!-- Caixa 1: Artigos -->
  <!--<div style="border: 2px solid #ddd; border-radius: 8px; padding: 20px; width: 80%; margin: 10px auto; text-align: left;">
    <h3>📄 Articles & Publications</h3>
    <ul>
      <li><a href="URL_DO_ARTIGO_1" target="_blank" rel="noopener noreferrer">Article Title 1</a></li>
      <li><a href="URL_DO_ARTIGO_2" target="_blank" rel="noopener noreferrer">Article Title 2</a></li>
      <li><a href="URL_DO_ARTIGO_3" target="_blank" rel="noopener noreferrer">Article Title 3</a></li>
    </ul>
  </div>-->

  <!-- Caixa 2: Repositórios em destaque -->
  <!--<div style="border: 2px solid #ddd; border-radius: 8px; padding: 20px; width: 80%; margin: 10px auto; text-align: left;">
    <h3>📂 Featured Repos</h3>
    <ul>
      <li><a href="https://github.com/Francionlj/REPO1" target="_blank" rel="noopener noreferrer">Repo 1</a></li>
      <li><a href="https://github.com/Francionlj/REPO2" target="_blank" rel="noopener noreferrer">Repo 2</a></li>
      <li><a href="https://github.com/Francionlj/REPO3" target="_blank" rel="noopener noreferrer">Repo 3</a></li>
    </ul>
  </div>-->
